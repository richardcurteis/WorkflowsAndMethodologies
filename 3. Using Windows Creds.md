...
The Windows [sc](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-xp/bb490995(v=technet.10)?redirectedfrom=MSDN) command is used to query, create, delete, etc Windows services and can be used remotely.
